CLASS zcl_sat_adt_param_util DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PRIVATE SECTION.
    CONSTANTS c_parameter_separator TYPE c LENGTH 1 VALUE ';' ##NO_TEXT.
    CONSTANTS c_key_value_separator TYPE c LENGTH 1 VALUE '=' ##NO_TEXT.
...
CLASS zcl_sat_adt_param_util IMPLEMENTATION.
  METHOD constructor.
  ...
  METHOD set_parameter.
    ...
    DATA lv_param_value TYPE c LENGTH 255.
    DATA lv_parameter_key TYPE c LENGTH 20.
  ...
  METHOD get_parameters.
    ...
    WHILE strlen( lv_rest ) > 0.
      ...
      set_parameter( CHANGING cv_parameter_string = lv_rest ).
