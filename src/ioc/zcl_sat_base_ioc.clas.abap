...
CLASS zcl_sat_base_ioc DEFINITION
  ...
  PROTECTED SECTION.
    ...
    "!
    "! @parameter iv_contract | <p class="shorttext synchronized">The name of the interface contract</p>
    "! @parameter iv_lifetime | <p class="shorttext synchronized">The lifetime for the contract</p>
    "! @parameter ro_contract | <p class="shorttext synchronized">The created contract instance</p>
