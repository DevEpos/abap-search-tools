...
CLASS zcl_sat_clsintf_query_config IMPLEMENTATION.
  METHOD constructor.
    ...
    DATA(lt_object_filters) = VALUE zif_sat_ty_object_search=>ty_t_query_filter(
        ...
        ( name = c_class_intf_search_option-method allowed_length = 61 )
        ( name = c_class_intf_search_option-interface allowed_length = 30 )
        ( name = c_class_intf_search_option-attribute allowed_length = 30 key_value = abap_true )
