...
CLASS zcl_sat_clif_search_param_util DEFINITION
  ...
  PUBLIC SECTION.
    ...
    "! <p class="shorttext synchronized">Converts abap language to external format</p>
    "!
    "! @parameter iv_internal    | <p class="shorttext synchronized">internal format</p>
    "! @parameter ev_external    | <p class="shorttext synchronized">external format</p>
    "! @parameter ev_description | <p class="shorttext synchronized">Description of the category</p>
    ...
    "! <p class="shorttext synchronized">Converts abap language to internal format</p>
    "!
    "! @parameter iv_external | <p class="shorttext synchronized">external format</p>
    "! @parameter rv_internal | <p class="shorttext synchronized">internal format</p>
...
CLASS zcl_sat_clif_search_param_util IMPLEMENTATION.
  METHOD class_constructor.
    ...
    lo_abap_lang_type_descr->get_ddic_fixed_values( RECEIVING  p_fixed_values = mt_abap_lang_values
                                                    EXCEPTIONS not_found      = 1
                                                               no_ddic_type   = 2
                                                               OTHERS         = 3 ).
  ENDMETHOD.
  ...
  METHOD convert_abap_lang_to_ext.
    ...
    CASE iv_internal.
      ...
      WHEN ''.
        ev_external = zif_sat_c_os_clif_options=>c_abap_lang_versions-non_unicode.
        ev_description = 'Non-Unicode ABAP'.

      WHEN 'X'.
        ev_external = zif_sat_c_os_clif_options=>c_abap_lang_versions-unicode.
        ev_description = 'Standard ABAP (Unicode)'.

      WHEN '2'.
        ev_external = zif_sat_c_os_clif_options=>c_abap_lang_versions-key_user.
        ev_description = 'ABAP for key users'.

      WHEN '3'.
        ev_external = zif_sat_c_os_clif_options=>c_abap_lang_versions-static_abap_limited_use.
        ev_description = 'Static ABAP with limited object use'.

      WHEN '4'.
        ev_external = zif_sat_c_os_clif_options=>c_abap_lang_versions-std_abap_limited_use.
        ev_description = 'Standard ABAP with limited object use'.

      WHEN '5'.
        ev_external = zif_sat_c_os_clif_options=>c_abap_lang_versions-cloud_platform.
  ...
  METHOD convert_abap_lang_to_int.
    CASE iv_external.
      ...
      WHEN zif_sat_c_os_clif_options=>c_abap_lang_versions-unicode.
        rv_internal = 'X'.

      WHEN zif_sat_c_os_clif_options=>c_abap_lang_versions-key_user.
        rv_internal = '2'.

      WHEN zif_sat_c_os_clif_options=>c_abap_lang_versions-static_abap_limited_use.
        rv_internal = '3'.

      WHEN zif_sat_c_os_clif_options=>c_abap_lang_versions-std_abap_limited_use.
        rv_internal = '4'.

      WHEN zif_sat_c_os_clif_options=>c_abap_lang_versions-cloud_platform.
        rv_internal = '5'.

      WHEN zif_sat_c_os_clif_options=>c_abap_lang_versions-non_unicode.
        rv_internal = ''.
  ...
  METHOD get_abap_languages.
    rt_languages = VALUE #( FOR cat IN mt_abap_lang_values
                            ( |{ cat-low }| ) ).
  ENDMETHOD.
