...
CLASS zcl_sat_base_query_config DEFINITION
  ...
  PROTECTED SECTION.
    ...
    CONSTANTS c_vh_category_scheme        TYPE string VALUE 'http://www.devepos.com/adt/saat/objectsearch'.
    ...
    DATA mt_options         TYPE zif_sat_ty_object_search=>ty_t_option_setting.
