CLASS zcx_sat_conversion_exc DEFINITION
  ...
  PUBLIC SECTION.
    CLASS-METHODS create_from_sy
      RETURNING
        VALUE(rr_exception) TYPE REF TO zcx_sat_conversion_exc.
...
CLASS zcx_sat_conversion_exc IMPLEMENTATION.
...
*&---------------------------------------------------------------------*
    rr_exception = NEW zcx_sat_conversion_exc( textid = VALUE scx_t100key( msgid = sy-msgid
                                                                           msgno = sy-msgno
                                                                           attr1 = 'MSGV1'
                                                                           attr2 = 'MSGV2'
                                                                           attr3 = 'MSGV3'
