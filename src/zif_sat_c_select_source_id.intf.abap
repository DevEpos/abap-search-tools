...
INTERFACE zif_sat_c_select_source_id
  ...
  CONSTANTS zsat_i_cdsbasefield TYPE string VALUE 'ZSAT_I_CDSBASEFIELD'.
  ...
  CONSTANTS zsat_i_tabletext TYPE string VALUE 'ZSAT_I_TABLETEXT'.
  ...
  CONSTANTS zsat_i_structure TYPE string VALUE 'ZSAT_I_STRUCTURE'.
ENDINTERFACE.
