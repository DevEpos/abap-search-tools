"! <p class="shorttext synchronized">Reads element information for a Database View</p>
...
CLASS zcl_sat_adt_view_elinfo_rdr IMPLEMENTATION.
  ...
  METHOD zif_sat_adt_elinfo_reader~read_element_information.
    ...
    TRY.
        io_rest_response->set_body_data( content_handler = zcl_sat_adt_ch_factory=>create_view_elem_info_res_ch( )
