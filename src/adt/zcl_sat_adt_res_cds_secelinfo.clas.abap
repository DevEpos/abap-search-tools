...
CLASS zcl_sat_adt_res_cds_secelinfo DEFINITION
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Load the Metadata extension files</p>
    ...
    "! <p class="shorttext synchronized">Load the business object(s) of the CDS view</p>
    METHODS load_business_object.
    "! <p class="shorttext synchronized">Load the referenced/used classes of the CDS view</p>
...
CLASS zcl_sat_adt_res_cds_secelinfo IMPLEMENTATION.
  ...
  METHOD load_metadata_ext.
    ...
    LOOP AT lt_metadata_ext ASSIGNING FIELD-SYMBOL(<ls_metadata_ext>).
      ...
      <ls_adt_object> = VALUE #( name        = <ls_metadata_ext>-ddlxname
  ...
  METHOD load_business_object.
    ...
    ms_secondary_element_info-business_object = VALUE #( name     = lv_bo
                                                         raw_name = lv_bo
                                                         adt_type = 'BOBF'
                                                         uri      = zcl_sat_adt_util=>get_adt_object_ref_uri(
                                                                        iv_name = CONV #( lv_bo )
  ...
  METHOD load_referenced_classes.
    ...
    LOOP AT lt_classes ASSIGNING FIELD-SYMBOL(<ls_class>) WHERE clsname IS NOT INITIAL.
      ...
      <ls_adt_object> = VALUE #( name        = <ls_class>-clsname
