"! <p class="shorttext synchronized">Reads element information for a Database Table</p>
...
CLASS zcl_sat_adt_table_elinfo_rdr IMPLEMENTATION.
  ...
  METHOD zif_sat_adt_elinfo_reader~read_element_information.
    ...
    TRY.
        io_rest_response->set_body_data( content_handler = zcl_sat_adt_ch_factory=>create_table_elem_info_res_ch( )
                                         data            = VALUE zsat_adt_db_table_info(
                                             name               = ls_entity-entity
*............ Create URI for the technical settings of this table
                                             technical_settings = VALUE #(
                                                 name     = mv_tabname
                                                 raw_name = mv_tabname
                                                 ...
                                                 adt_type = 'TABL/DTT' )
                                             properties         = VALUE #( package      = ls_entity-developmentpackage
