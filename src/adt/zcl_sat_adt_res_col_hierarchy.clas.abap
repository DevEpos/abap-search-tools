"! <p class="shorttext synchronized">Resource for getting Field Hierarchy of Column</p>
...
CLASS zcl_sat_adt_res_col_hierarchy IMPLEMENTATION.
  METHOD internal_get.
    ...
    ms_field_info = lo_hierarchy_resolver->resolve_field_hierarchy( iv_cds_view       = mv_object_name
