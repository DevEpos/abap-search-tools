...
CLASS zcl_sat_adt_res_table_type_vh IMPLEMENTATION.
  METHOD get_named_items.
    p_named_item_list-items = VALUE #(
      ( name = zif_sat_c_object_browser=>c_type_option_value-table description = |{ 'Transparent Table'(001) }| )
      ( name = zif_sat_c_object_browser=>c_type_option_value-view  description = |{ 'Database View'(002) }| )
