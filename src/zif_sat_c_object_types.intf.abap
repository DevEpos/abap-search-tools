...
INTERFACE zif_sat_c_object_types
  ...
  CONSTANTS data_element TYPE string VALUE 'DTEL/DE'.
  ...
  CONSTANTS table_type TYPE string VALUE 'TTYP/DA'.
  CONSTANTS interface TYPE string VALUE 'INTF/OI'.
  CONSTANTS class TYPE string VALUE 'CLAS/OC'.
  CONSTANTS domain TYPE string VALUE 'DOMA/DD'.
  ...
  CONSTANTS type_group TYPE string VALUE 'TYPE/DG'.
  CONSTANTS set_get_param TYPE string VALUE 'PARA/R'.
  CONSTANTS search_help TYPE string VALUE 'SHLP/DH'.
ENDINTERFACE.
