...
CLASS zcl_sat_ob_generic_searcher DEFINITION
  PUBLIC
  ABSTRACT
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        ir_query TYPE REF TO zcl_sat_object_search_query.
  PROTECTED SECTION.
    ...
    METHODS split_including_excluding
      IMPORTING
        it_values    TYPE zif_sat_ty_object_browser=>ty_search_option_values-value_range
      EXPORTING
        et_including TYPE zif_sat_ty_object_browser=>ty_search_option_values-value_range
        et_excluding TYPE zif_sat_ty_object_browser=>ty_search_option_values-value_range.
    ...
    METHODS create_not_in_filter
      IMPORTING
        it_excluding          TYPE zif_sat_ty_object_browser=>ty_search_option_values-value_range
...
CLASS zcl_sat_ob_generic_searcher IMPLEMENTATION.
